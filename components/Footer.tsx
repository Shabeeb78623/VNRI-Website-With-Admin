      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-6 order-1 md:order-2">
            <a 
              href="https://www.facebook.com/profile.php?id=100082364254126" 
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-blue-900 p-3 rounded-full hover:bg-blue-700 hover:text-white transition-all transform hover:-translate-y-1 group"
              aria-label="Facebook"
            >
              <svg fill="currentColor" viewBox="0 0 24 24" className="h-6 w-6 text-blue-300 group-hover:text-white">
                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
              </svg>
            </a>
            <a 
              href="https://www.instagram.com/vnri.abudhabi?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" 
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-blue-900 p-3 rounded-full hover:bg-pink-700 hover:text-white transition-all transform hover:-translate-y-1 group"
