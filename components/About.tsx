    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-8 text-left space-y-6 text-gray-700 leading-relaxed">
          <p>
            Vadakara NRI Forum Abu Dhabi (VNRI) is a vibrant community organization dedicated to bringing together expatriates from Vadakara and surrounding regions. Established over two decades ago, our forum serves as a home away from home, fostering a strong sense of unity, culture, and mutual support among our members.
          </p>
          <p>
